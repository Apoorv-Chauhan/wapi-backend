...
const allowedOrigins = process.env.ALLOWED_ORIGINS
  ...
  : ["http://localhost:3000", "http://localhost:5173", "https://qwiktalks.com"];
...
import("./services/whatsapp/unified-whatsapp.service.js")
  .then((module) => {
    module.default.setIO(io);
  })
  .catch((err) =>
    console.error("Error setting IO in unifiedWhatsAppService:", err),
  );
...
(async () => {
  try {
    ...
    import("./services/whatsapp/unified-whatsapp.service.js")
      ...
      .catch((err) =>
        console.error(
          "Error importing unifiedWhatsAppService for initialization:",
          err,
        ),
      );
